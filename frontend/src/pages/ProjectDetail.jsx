...
const ProjectDetail = () => {
    ...
    const workflowSteps = [
        { id: 'step1', title: 'Idéation & Planification', icon: <Edit3 />, status: 'Completed', color: 'bg-blue-500' },
        { id: 'step2', title: 'Ordonnancement', icon: <LayoutList />, status: 'In Progress', color: 'bg-purple-500' },
        { id: 'step3', title: 'Capture & Upload', icon: <Video />, status: 'Todo', color: 'bg-orange-500' },
        { id: 'step4', title: 'Revue & Feedback', icon: <MessageSquare />, status: 'Todo', color: 'bg-green-500' },
        { id: 'step5', title: 'Publication', icon: <CheckCircle />, status: 'Todo', color: 'bg-pink-500' },
    ]
                        ...
                        >
                            ...
                            <div className="flex-1 pt-1">
                                ...
                                <div className="p-6 rounded-2xl bg-white border border-border/60 shadow-sm hover:shadow-md transition-shadow">
                                    {step.status === 'Todo' ? (
                                        <p className="text-sm text-muted-foreground italic">Aucune tâche active pour cette étape.</p>
                                    ) : (
